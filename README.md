...
---
*The longest, most unemployed, and most importantly - 28 years too late - this is my proof that Brainfuck is Turing-complete.*
...
make
./main path/to/file
make clean        # optional - if you want to remove executable and object files
```
...
- TRANSITIONS tells the Turing machine what to do on each state:
Let
...
$$q\text{ }:\text{ }q_0\text{ }s_0\text{ }m_0\text{ }q_1\text{ }s_1\text{ }m_1$$
...
This is an example of how a config file might look like:
```c
.section CONFIG
    FILE        assets/busybeaver4.bf
    HEADPOS     25
...
```
### 5. Technical details
For now I'm not doing it. I also don't know what to add here.